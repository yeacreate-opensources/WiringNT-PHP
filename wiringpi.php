...
abstract class wiringpi {
	...
	static function YeaCreate_get_physToGpio($rev) {
		return YeaCreate_get_physToGpio($rev);
	}

	static function YeaCreate_get_pinToGpio($rev) {
		return YeaCreate_get_pinToGpio($rev);
	}

	static function YeaCreate_Ntablet_setup($rev) {
		return YeaCreate_Ntablet_setup($rev);
	}

	static function YeaCreate_get_pin_mode($pin) {
		return YeaCreate_get_pin_mode($pin);
	}

	static function YeaCreate_set_pinmode_as_gpio($pin) {
		YeaCreate_set_pinmode_as_gpio($pin);
	}

	static function YeaCreate_set_pin_mode($pin,$mode) {
		YeaCreate_set_pin_mode($pin,$mode);
	}

	static function YeaCreate_digitalWrite($pin,$value) {
		YeaCreate_digitalWrite($pin,$value);
	}

	static function YeaCreate_digitalRead($pin) {
		return YeaCreate_digitalRead($pin);
	}

	static function YeaCreate_pullUpDnControl($pin,$pud) {
		YeaCreate_pullUpDnControl($pin,$pud);
	}

	static function YeaCreate_set_pwmPeriod($pin,$period) {
		YeaCreate_set_pwmPeriod($pin,$period);
	}

	static function YeaCreate_set_pwmRange($range) {
		YeaCreate_set_pwmRange($range);
	}

	static function YeaCreate_set_pwmFrequency($pin,$divisor) {
		YeaCreate_set_pwmFrequency($pin,$divisor);
	}

	static function YeaCreate_set_pwmClock($divisor) {
		YeaCreate_set_pwmClock($divisor);
	}

	static function YeaCreate_pwm_write($pin,$value) {
		YeaCreate_pwm_write($pin,$value);
	}

	static function YeaCreate_pwmToneWrite($pin,$freq) {
		YeaCreate_pwmToneWrite($pin,$freq);
	}

	static function YeaCreate_set_gpioClockFreq($pin,$freq) {
		YeaCreate_set_gpioClockFreq($pin,$freq);
	}

	static function YeaCreate_get_pinAlt($pin) {
		return YeaCreate_get_pinAlt($pin);
	}

	static function YeaCreate_set_pinAlt($pin,$alt) {
		YeaCreate_set_pinAlt($pin,$alt);
	}

	static function YeaCreate_set_GpioDriveStrength($pin,$drv_type) {
		YeaCreate_set_GpioDriveStrength($pin,$drv_type);
	}

	static function YeaCreate_get_GpioDriveStrength($pin) {
		return YeaCreate_get_GpioDriveStrength($pin);
	}

	static function YeaCreate_cleanup() {
		YeaCreate_cleanup();
	}

	static function gpio_clk_enable() {
		gpio_clk_enable();
	}

	static function YeaCreate_ReadADC0() {
		return YeaCreate_ReadADC0();
	}
	...
	static function getPinMode($pin) {
		return getPinMode($pin);
	}

	static function setPwmPeriod($pin,$period) {
		setPwmPeriod($pin,$period);
	}

	static function setPwmFrequency($pin,$divisor) {
		setPwmFrequency($pin,$divisor);
	}

	static function setGpioDrive($pin,$drv_type) {
		setGpioDrive($pin,$drv_type);
	}

	static function getGpioDrive($pin) {
		return getGpioDrive($pin);
	}

	static function piGpioLayout() {
		return piGpioLayout();
	}
	...
	static function loadWPiExtension($progName,$extensionData,$verbose) {
		return loadWPiExtension($progName,$extensionData,$verbose);
	}
	...
	static function piFaceSetup($pinBase) {
		return piFaceSetup($pinBase);
	}
